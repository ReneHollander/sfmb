...
import at.er.ytbattle.plugin.feature.event.FeatureRegisterEvent;
import at.er.ytbattle.plugin.feature.event.FeatureUnregisterEvent;
...
public class FeatureManager {
    ...
    public void registerFeature(Feature f) {
        ...
        if (event.isCancelled()) {
            ...
            Bukkit.getPluginManager().registerEvents(f, this.plugin);
